...
def cross_validate(csv_path, dir_out, random_state=42, normalize = False):
    ...
    fs_alg_names = ['mRMR', 'lasso', 'elastic_net', 'svm_rfe',# 'boruta',
                    'fisher', 'chi2', 'cfs', 'info_gain', 'relieff'] #, 'cfs', 'info_gain', 'relieff', 'jackstraw', 'stability_selection'
...
dir_out = '/home/dong/feature_selection/data/non_dl/'
