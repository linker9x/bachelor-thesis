...
def cross_validate(csv_path, dir_out, random_state=42, normalize = False):
    ...
    fs_alg_names = ['relieff', 'lasso', 'svm_rfe', 'elastic_net', 'hsic_lasso'] #, 'cfs', 'info_gain', 'relieff', 'jackstraw', 'stability_selection'
    ...
    for train_index, test_index in cv.split(X, y):
        ...
        for alg_name in fs_alg_names:
            if alg_name == 'mRMR' or alg_name == 'hsic_lasso':
                continue
            new_vals = non_dl_wrapper(alg_name, X_train, y_train, feature_names)
        ...
        for alg_name in fs_alg_names:
            ...
            for per_feat in per_feats:
                ...
                if alg_name == 'mRMR':
                    selected_feats = mmr_wrapper(X_train, y_train, feature_names, num_feat)
                ...
                if alg_name not in ['mRMR', 'hsic_lasso']:
                    ...
                    selected_feats_dict[alg_name][fold_idx].append('PER_FEAT_' + str(per_feat))
...
dir = '/home/ngandong/Desktop/Code/feature_selection/bachelor-thesis-fs/data/standardize/'
csv_path = dir + 'GLIOMA.csv'
dir_out = '/home/ngandong/Desktop/Code/feature_selection/bachelor-thesis-fs/data/non_dl_cross_val/'
dir = '/home/dong/feature_selection/data/subset_June30/'
dir_out = '/home/dong/feature_selection/data/non_dl_percentage/'
dir = '/home/ngandong/Desktop/Code/feature_selection/bachelor-thesis-fs/data/standardize/subset_June30/'
dir_out = dir + 'non_dl_result/'
# dir = '/home/dong/bachelor-thesis-fs/data/standardize/'
# dir_out = '/home/dong/bachelor-thesis-fs/data/non_dl_cross_val/'
...
cross_validate_dir(test_dir, test_dir, True)
#dir_in = '/home/dong/feature_selection/data/subset_June30/'
#dir_out = '/home/dong/feature_selection/data/jul17/non_dl/'
#cross_validate_dir(dir_in, dir_out, True)
